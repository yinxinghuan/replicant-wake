...
- 游戏：Replicant Wake
- 类型：other
- 简述：2089 高端定制陪伴 replicant 在化妆台前度过她'第一次成为人'的午夜。5 个全息物件,5 段她说出口的台词。她不知道——每句话都是别人记忆的复制。Climax 让你选她接下来变成谁。AlterU After Dark FMV 第 2 作。
...
- 平台元信息：meta.title=Replicant Wake；cover_url=/poster.png；category=other；uuid=161e9901-20bf-4df9-abb2-fbd1a11a753f
...
- `src/Game/Game.tsx`：React 组件和交互界面。
- `src/Game/i18n.ts`：中英文或多语言文案。
- `src/Game/Game.less`：视觉样式、布局、动画和响应式规则。
